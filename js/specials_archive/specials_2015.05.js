...
var heartIcon = L.icon({
    iconRetinaUrl: 'images/special-marker-flower.png',
    iconUrl: 'images/special-marker-flower.png',
    iconSize: [24, 24],
    iconAnchor: [10, 10],
    popupAnchor: [3, -3]
...
var speshl = $.getJSON( 'js/fmflowers.geojson', function( data ) {
...
var pu = "<a href='"+d.properties.Website+"'>"+d.properties.MarketName+"</a>"
